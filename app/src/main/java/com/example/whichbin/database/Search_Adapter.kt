...
class search_Adapter(val search_List: List<search_result>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when(Type){
            "厨余垃圾"->holder.typeimage.setImageResource(R.drawable.trash1)
            "可回收物"->holder.typeimage.setImageResource(R.drawable.trash2)
            "有害垃圾"->holder.typeimage.setImageResource(R.drawable.trash3)
            "其他垃圾"->holder.typeimage.setImageResource(R.drawable.trash4)
        }
    }
